...
enum NIM_InstallationMode
{
    ...
    IM_UNKNOWN1 = 1, ///< Unknown
    IM_UNKNOWN2 = 2, ///< Unknown
    IM_REINSTALL = 3 ///< Reinstall currently installed title; use this if the title is already installed (including updates)
}
...
enum NIM_DownloadState
{
    ...
    DS_INITIALIZED = 1, ///< Download initialized
    DS_DOWNLOAD_TMD = 2, ///< Downloading and installing TMD
    DS_PREPARE_SAVE_DATA = 3, ///< Initializing save data
    DS_DOWNLOAD_CONTENTS = 4, ///< Downloading and installing contents
    DS_WAIT_COMMIT = 5, ///< Waiting before calling AM_CommitImportTitles
    DS_COMMITTING = 6, ///< Running AM_CommitImportTitles
    DS_FINISHED = 7, ///< Title installation finished
    DS_VERSION_ERROR = 8, ///< (unknown error regarding title version)
    DS_CREATE_CONTEXT = 9, ///< Creating the .ctx file?
    DS_CANNOT_RECOVER = 10, ///< Irrecoverable error encountered (e.g. out of space)
    DS_INVALID = 11 ///< Invalid state
}

...
enum HID_Event
{
    ...
    HIDEVENT_PAD1 = 1, ///< Event signaled by HID-module, when the sharedmem+0(PAD/circle-pad)/+0xA8(touch-screen) region was updated.
    HIDEVENT_Accel = 2, ///< Event signaled by HID-module, when the sharedmem accelerometer state was updated.
    HIDEVENT_Gyro = 3, ///< Event signaled by HID-module, when the sharedmem gyroscope state was updated.
    HIDEVENT_DebugPad = 4, ///< Event signaled by HID-module, when the sharedmem DebugPad state was updated.

    HIDEVENT_MAX = 5 ///< Used to know how many events there are.
}
